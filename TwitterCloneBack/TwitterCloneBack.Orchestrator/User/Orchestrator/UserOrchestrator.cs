...
public class UserOrchestrator(
    IUserRepository userRepository) : IUserOrchestrator
{
    ...
    {
        return await userRepository.IsUserAlreadyExistsAsync(email, username);
    }
    ...
    {
        return await userRepository.CreateUserAsync(new UserDto
        {
    ...
    public async Task<UserDto> UpdateUserAsync(UpdateUser updateUser)
    {
        ...
        user.DisplayUsername =
            updateUser.DisplayUsername ?? user.DisplayUsername;
        ...
        if (updateUser.Password != null)
        {
            ...
            user.PasswordHash =
                HashPassword(updateUser.Password) ?? user.PasswordHash;
        }
